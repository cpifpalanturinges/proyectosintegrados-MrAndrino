...
function UserProfileContent({
  ...
  const [panelDirection, setPanelDirection] = useState<ProfilePanelDirection>('forward')
  ...
  async function handleSaveProfile() {
    ...
    try {
      ...
      console.error(error)
      setProfileError(error instanceof Error ? error.message : 'No se ha podido actualizar el perfil.')
    } finally {
  ...
  async function handleChangeProfilePhoto(photo: File) {
    ...
    try {
      ...
      console.error(error)
      setProfileError(error instanceof Error ? error.message : 'No se ha podido cambiar la imagen.')
    } finally {
  ...
  async function handleDeleteProfilePhoto() {
    ...
    try {
      ...
      console.error(error)
      setProfileError(error instanceof Error ? error.message : 'No se ha podido borrar la imagen.')
    } finally {
      setIsSavingPhoto(false)
    }
  }
  ...
  async function handleChangePassword(newPassword: string) {
    ...
    try {
      ...
      console.error(error)
      setProfileError(
        error instanceof Error ? error.message : 'No se ha podido cambiar la contraseña.',
      )
    } finally {
  ...
  async function handleRemoveFromTeam() {
    ...
    try {
      ...
      console.error(error)
      setProfileError(error instanceof Error ? error.message : 'No se ha podido expulsar del equipo.')
    } finally {
  ...
  async function handleDeleteUser() {
    ...
    try {
      ...
      console.error(error)
      setProfileError(error instanceof Error ? error.message : 'No se ha podido eliminar el usuario.')
    } finally {
  ...
  return (
    ...
    >
      ...
      {activePanel === 'profile' && (
        <>
          <UserCard user={user} variant="profile" showUsername showRole showTeam />
          ...
          <div className="profile-form-grid">
            ...
            <label className="profile-form-field profile-form-field--full">
              ...
              <input
                ...
                onChange={(event) => updateProfileField('studies', event.target.value)}
              />
            </label>
            ...
            <label className="profile-form-field">
              ...
              <input
                ...
                onChange={(event) => updateProfileField('skill1', event.target.value)}
              />
            </label>
            ...
            <label className="profile-form-field">
              ...
              <input
                ...
                onChange={(event) => updateProfileField('skill2', event.target.value)}
              />
            </label>
            ...
            <label className="profile-form-field">
              ...
              <input
                ...
                onChange={(event) => updateProfileField('skill3', event.target.value)}
              />
            </label>
            ...
            <label className="profile-form-field">
              ...
              <input
                ...
                onChange={(event) => updateProfileField('skill4', event.target.value)}
              />
            </label>
          </div>
      ...
      {activePanel === 'confirmation' && confirmation && (
        <div className="profile-confirmation-inline">
          <div className="profile-confirmation-card">
            <p className="profile-confirmation-message">{confirmation.message}</p>
            ...
            <div className="profile-confirmation-actions">
              ...
              >
                {isConfirmingAction ? 'Procesando...' : confirmation.confirmLabel}
              </button>
