    ...
    <div className="photo-input">
      ...
      {!previewUrl && (
        <>
          <div className="photo-input-actions">
            <button type="button" className="photo-input-button" onClick={openFilePicker}>
              Elegir archivo
            </button>

            <button type="button" className="photo-input-button" onClick={openCamera}>
              Hacer foto
            </button>
          </div>

          <span className="field-hint">Hazte un selfie o sube una foto tipo carnet.</span>
        </>
      )}
      ...
      {previewUrl && (
        <button
          ...
          title="Quitar foto"
        >
          <img className="photo-input-preview" src={previewUrl} alt="Vista previa de la foto" />
        ...
        <div className="camera-modal" role="dialog" aria-modal="true">
          <div className="camera-card">
            ...
            <div className="camera-actions">
              ...
              <button type="button" className="camera-secondary-button" onClick={closeCamera}>
                Cancelar
              </button>
            </div>
          </div>
